...
public class Constants {
	...
	public static final String ERROR_MESSAGEFOR_VALID_LOGIN="Dashboard not loaded";
	public static final String ERROR_MESSAGEFOR_INVAILD_LOGIN="Alert for incorrect credentials not loaded";
